...
if __name__ == "__main__":
    with app.app_context():
        ...
        # db.session.commit()
        #
        # airport1 = Airport(name='Noi Bai')
        # airport2 = Airport(name='Tan Son Nhat')
        # airport3 = Airport(name='Can Tho')
        # airport4 = Airport(name='Da Nang')
        # airport5 = Airport(name='Ca Mau')
        # airport6 = Airport(name='Phu Quoc')
        # airport7 = Airport(name='Dien Bien Phu')
        # airport8 = Airport(name='Tho Xuan')
        # airport9 = Airport(name='Phu Bai')
        # airport10 = Airport(name='Pleiku')
        # airport11 = Airport(name='Chu Lai')
        # airport12 = Airport(name='Dong Hoi')
        # airport13 = Airport(name='Rach Gia')
        # airport14 = Airport(name='Buon Ma Thuot')
        # airport15 = Airport(name='Lien Khuong')
        # airport16 = Airport(name='Con Dao')
        # airport17 = Airport(name='Vinh ')
        #
        # db.session.add_all([airport1, airport2, airport3, airport4, airport5, airport6, airport7, airport8, airport9 , airport10,
        #                     airport11, airport12, airport13, airport14, airport15, airport16,airport17])
        # db.session.commit()
        #
        # route1 = Route(name='Ha Noi - TP HCM')
        # route2 = Route(name='Can Tho - TP HCM')
        # route3= Route(name='Da Nang - TP HCM')
        # route4 = Route(name='Ca Mau - Phu Quoc')
        # route5= Route(name='Can Tho - Ha Noi')
        # route6 = Route(name='Phu Quoc - Tho Xuan')
        # route7 = Route(name='Dien Bien Phu - Tho Xuan')
        # route8 = Route(name='Tho Xuan - Can Tho')
        # route9 = Route(name='Ha Noi - Phu Bai')
        # route10 = Route(name='Pleiku - Dong Hoi')
        # route11 = Route(name='Chu Lai - Phu Bai')
        # route12 = Route(name='Tho Xuan - TP HCM')
        # route13 = Route(name='Rach Gia - Can Tho')
        # route14 = Route(name='Buon Ma Thuot - TP HCM')
        # route15 = Route(name='Rach Gia - Lien Khuong')
        # route16 = Route(name='Con Dao - Phu Quoc')
        # route17 = Route(name='Phu Cat - Tho Xuan')
        # route18 = Route(name='Vinh - Tho Xuan')
        # route19 = Route(name='Lien Khuong - Can Tho')
        # route20 = Route(name='Chu Lai - Phu Bai')
        ...
        # fareclass1 = FareClass(name='Ghe Hang 1',price=rule3.value)
        # fareclass2 = FareClass(name= 'Ghe Hang 2',price=rule4.value)
